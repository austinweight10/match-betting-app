...
import {read} from './genericFunctions.js';
...
(() => {
            ...
            // calculate winnings
             ...
             prevres[data.name] = (
                  ...
                  <div className="MB__prev-res__res">
                    ...
                    <h3 className={data.name}>Bet {counter}</h3>
                    ...
                    <div>
                        ...
                        <button className="MB__prev-res__delete">Delete result</button>
    ...
    // delete results
    $('.MB__prev-res__delete').on('click', function() {
        const cookieName = $(this).parents().find('h3').attr('class')
        Cookies.remove(cookieName);
        location.reload();
    });

    // read mmore function
    read($(".MB__prev-res__read-more"), readMC, readMHC);
